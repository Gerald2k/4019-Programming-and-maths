...
void Update()
{
	...
	case PLAY:
	{
		...
		if (hasLanded)
		{
			WriteTextToBuffer(consoleBuffer, "THE EAGLE HAS LANDED", WIDTH / 2, HEIGHT / 2);
		}
		else if (hasCrashed)
		{
			WriteTextToBuffer(consoleBuffer, "fuuuuuuuck", WIDTH / 2, HEIGHT / 2);
		}
